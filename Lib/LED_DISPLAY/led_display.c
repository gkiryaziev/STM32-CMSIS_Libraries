...
void TIM2_IRQHandler() {
    ...
    HC595_SPI_SendByte(LED_Display_Digits[LED_Display_Buffer[LED_Display_Current_Digit]]);

    if (LED_Display_Current_Digit == 0)
        GPIO_WritePin(LED_DIG1_Port, LED_DIG1_Pin, 1);
    else
        GPIO_WritePin(LED_DIG2_Port, LED_DIG2_Pin, 1);
}
